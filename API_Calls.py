...
# insert api token
api_token = "vk1.a.xlTzoH7jlxYJBsn46Y6u0cdE-PwWA6MYotWleY6gk-Jj1yRfC28qZp4qIoiAyNs1gf-vTq_lcfg_Ygaxk8ym3FUCds3VWGPhPAuaiOp0tJvJONhxAdAGgP2QVqoN8cULQeOFns_OVAVn_ymXPL84-ZuUa-jycmeVAOuYGVJvlP8a0crZZerbOaWVrwl49GD-woBj003rw7wI7SUGZHOF1A"
...
def _get_members_list(community_name):
    ...
    needed_requests = min(math.ceil(amount_of_subscribers / 1000), 2)
    offset = 0
